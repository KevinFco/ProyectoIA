...
import {
  IconBase,
  TimesIcon
} from "./chunk-JAOCHUDW.js";
import {
  Portal,
  Tooltip
} from "./chunk-Q24WJ6JR.js";
import {
  ComponentBase,
  DomHandler,
  EventBus,
...
var CSSTransition = function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return import_react3.default.createElement(Transition_default, _extends3({}, props, {
...
CSSTransition.propTypes = true ? _extends3({}, Transition_default.propTypes, {
  /**
  ...
  _proto.handleExited = function handleExited(child, node) {
    ...
    if (this.mounted) {
      this.setState(function(state2) {
        var children2 = _extends3({}, state2.children);
...
var CSSTransition2 = React9.forwardRef(function(inProps, ref) {
  ...
  return React9.createElement(CSSTransition_default, mergedProps, props.children);
});
...
var SearchIcon = React10.memo(React10.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
  return React10.createElement("svg", _extends4({
    ref,
    width: "14",
    height: "14",
    viewBox: "0 0 14 14",
...
var VirtualScroller = React11.memo(React11.forwardRef(function(inProps, ref) {
  ...
  var _React$useState = React11.useState(both ? {
    rows: 0,
    cols: 0
  } : 0), _React$useState2 = _slicedToArray(_React$useState, 2), firstState = _React$useState2[0], setFirstState = _React$useState2[1];
  var _React$useState3 = React11.useState(both ? {
    rows: 0,
    cols: 0
  } : 0), _React$useState4 = _slicedToArray(_React$useState3, 2), lastState = _React$useState4[0], setLastState = _React$useState4[1];
  var _React$useState5 = React11.useState(0), _React$useState6 = _slicedToArray(_React$useState5, 2), pageState = _React$useState6[0], setPageState = _React$useState6[1];
  var _React$useState7 = React11.useState(both ? {
    rows: 0,
    cols: 0
  ...
  var _React$useState9 = React11.useState(props.numToleratedItems), _React$useState10 = _slicedToArray(_React$useState9, 2), numToleratedItemsState = _React$useState10[0], setNumToleratedItemsState = _React$useState10[1];
  var _React$useState11 = React11.useState(props.loading || false), _React$useState12 = _slicedToArray(_React$useState11, 2), loadingState = _React$useState12[0], setLoadingState = _React$useState12[1];
  var _React$useState13 = React11.useState([]), _React$useState14 = _slicedToArray(_React$useState13, 2), loaderArrState = _React$useState14[0], setLoaderArrState = _React$useState14[1];
  ...
  var _contentRef = React11.useRef(null);
  var _spacerRef = React11.useRef(null);
  var _stickyRef = React11.useRef(null);
  var lastScrollPos = React11.useRef(both ? {
    top: 0,
    left: 0
  } : 0);
  var scrollTimeout = React11.useRef(null);
  var resizeTimeout = React11.useRef(null);
  var contentStyle = React11.useRef({});
  var spacerStyle = React11.useRef({});
  var defaultWidth = React11.useRef(null);
  var defaultHeight = React11.useRef(null);
  var defaultContentWidth = React11.useRef(null);
  var defaultContentHeight = React11.useRef(null);
  var isItemRangeChanged = React11.useRef(false);
  var lazyLoadState = React11.useRef(null);
  ...
  var createLoaderItem = function createLoaderItem2(index) {
    ...
    return React11.createElement(React11.Fragment, {
      key: index
    }, content2);
  };
  var createLoader = function createLoader2() {
    ...
    var icon = props.loadingIcon || React11.createElement(SpinnerIcon, _extends5({}, loadingIconProps, {
      spin: true
    }));
    ...
    if (!props.loaderDisabled && props.showLoader && loadingState) {
      ...
      return React11.createElement("div", loaderProps, _content);
    }
    return null;
  };
  var createSpacer = function createSpacer2() {
    if (props.showSpacer) {
      ...
      return React11.createElement("div", spacerProps);
    }
    return null;
  };
  ...
  var createContent = function createContent2() {
    ...
    var content2 = React11.createElement("div", contentProps, items);
  ...
  if (props.disabled) {
    ...
    return React11.createElement(React11.Fragment, null, props.children, _content2);
  }
  ...
  return React11.createElement("div", rootProps, content, spacer, loader);
}));
...
var CheckIcon = React12.memo(React12.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
  return React12.createElement("svg", _extends6({
    ref,
    width: "14",
    height: "14",
    viewBox: "0 0 14 14",
...
var BlankIcon = React13.memo(React13.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
  return React13.createElement("svg", _extends7({
    ref,
    width: "14",
    height: "14",
    viewBox: "0 0 14 14",
    fill: "none",
    xmlns: "http://www.w3.org/2000/svg"
  }, pti), React13.createElement("rect", {
    width: "1",
    height: "1",
    fill: "currentColor",
    fillOpacity: "0"
...
var DropdownItem = React13.memo(function(props) {
  var mergeProps = useMergeProps();
  ...
  var iconRenderer = function iconRenderer2() {
    if (selected) {
      ...
      return React13.createElement(CheckIcon, checkIconProps);
    }
    var blankIconProps = mergeProps({
      className: cx("blankIcon")
    }, getPTOptions("blankIcon"));
    return React13.createElement(BlankIcon, blankIconProps);
  };
  return React13.createElement("li", itemProps, checkmark && iconRenderer(), React13.createElement("span", itemGroupLabelProps, content), React13.createElement(Ripple, null));
});
...
var DropdownPanel = React13.memo(React13.forwardRef(function(props, ref) {
  var mergeProps = useMergeProps();
  var ptm = props.ptm, cx = props.cx, sx = props.sx;
  var context = React13.useContext(PrimeReactContext);
  var filterInputRef = React13.useRef(null);
  ...
  var createFooter = function createFooter2() {
    if (props.panelFooterTemplate) {
      ...
      return React13.createElement("div", footerProps, content);
    }
    return null;
  };
  ...
  var createEmptyMessage = function createEmptyMessage2(emptyMessage, isFilter) {
    ...
    return React13.createElement("li", emptyMessageProps, message);
  };
  var createItem = function createItem2(option, index) {
    ...
    if (option.group && props.optionGroupLabel) {
      ...
      return React13.createElement("li", _extends7({
        key
      }, itemGroupProps), React13.createElement("span", itemGroupLabelProps, groupContent));
    }
    var optionKey = props.getOptionRenderKey(option) + "_" + index;
    var optionLabel = props.getOptionLabel(option);
    var disabled = props.isOptionDisabled(option);
    return React13.createElement(DropdownItem, {
      key: optionKey,
      label: optionLabel,
      index,
  ...
  var createFilterClearIcon = function createFilterClearIcon2() {
    if (props.showFilterClear && props.filterValue) {
      ...
      var icon = props.filterClearIcon || React13.createElement(TimesIcon, clearIconProps);
  ...
  var createFilter = function createFilter2() {
    if (props.filter) {
      ...
      var icon = props.filterIcon || React13.createElement(SearchIcon, filterIconProps);
      ...
      var content = React13.createElement("div", filterContainerProps, React13.createElement("input", filterInputProps), clearIcon, filterIcon);
      ...
      return React13.createElement("div", headerProps, content);
    }
    return null;
  };
  var createContent = function createContent2() {
    if (props.virtualScrollerOptions) {
      var virtualScrollerProps = _objectSpread$1(_objectSpread$1({}, props.virtualScrollerOptions), {
        ...
        contentTemplate: function contentTemplate(options) {
          ...
          return React13.createElement("ul", listProps2, content);
        }
      });
      return React13.createElement(VirtualScroller, _extends7({
    ...
    return React13.createElement("div", wrapperProps, React13.createElement("ul", listProps, items));
  };
  var createElement8 = function createElement9() {
    ...
    return React13.createElement(CSSTransition2, _extends7({
      nodeRef: ref
    }, transitionProps), React13.createElement("div", _extends7({
      ref
    }, panelProps), props.firstFocusableElement, filter, content, footer, props.lastFocusableElement));
  };
  var element = createElement8();
  return React13.createElement(Portal, {
    element,
...
var Dropdown = React13.memo(React13.forwardRef(function(inProps, ref) {
  var mergeProps = useMergeProps();
  var context = React13.useContext(PrimeReactContext);
  var props = DropdownBase.getProps(inProps, context);
  var _React$useState = React13.useState(""), _React$useState2 = _slicedToArray2(_React$useState, 2), filterState = _React$useState2[0], setFilterState = _React$useState2[1];
  var _React$useState3 = React13.useState(false), _React$useState4 = _slicedToArray2(_React$useState3, 2), focusedState = _React$useState4[0], setFocusedState = _React$useState4[1];
  var _React$useState5 = React13.useState(-1), _React$useState6 = _slicedToArray2(_React$useState5, 2), focusedOptionIndex = _React$useState6[0], setFocusedOptionIndex = _React$useState6[1];
  var _React$useState7 = React13.useState(false), _React$useState8 = _slicedToArray2(_React$useState7, 2), overlayVisibleState = _React$useState8[0], setOverlayVisibleState = _React$useState8[1];
  var clickedRef = React13.useRef(false);
  var elementRef = React13.useRef(null);
  var overlayRef = React13.useRef(null);
  var firstHiddenFocusableElementOnOverlay = React13.useRef(null);
  var lastHiddenFocusableElementOnOverlay = React13.useRef(null);
  var inputRef = React13.useRef(props.inputRef);
  var focusInputRef = React13.useRef(props.focusInputRef);
  var virtualScrollerRef = React13.useRef(null);
  var searchTimeout = React13.useRef(null);
  var searchValue = React13.useRef(null);
  React13.useRef(null);
  ...
  var createHiddenSelect = function createHiddenSelect2() {
    ...
    return React13.createElement("div", hiddenSelectedMessageProps, React13.createElement("select", selectProps, React13.createElement("option", optionProps, option.label)));
  };
  var createKeyboardHelper = function createKeyboardHelper2() {
    ...
    return React13.createElement("div", hiddenSelectedMessageProps, React13.createElement("input", inputProps));
  };
  var createLabel = function createLabel2() {
    ...
    if (props.editable) {
      ...
      return React13.createElement("input", _inputProps);
    }
    ...
    return React13.createElement("span", inputProps, content);
  };
  ...
  var createClearIcon = function createClearIcon2() {
    if (props.value != null && props.showClear && !props.disabled) {
      ...
      var icon = props.clearIcon || React13.createElement(TimesIcon, clearIconProps);
  ...
  var createLoadingIcon = function createLoadingIcon2() {
    ...
    var icon = props.loadingIcon || React13.createElement(SpinnerIcon, {
      spin: true
    });
    ...
    return React13.createElement("div", loadingButtonProps, loadingIcon);
  };
  var createDropdownIcon = function createDropdownIcon2() {
    ...
    var icon = props.dropdownIcon || React13.createElement(ChevronDownIcon, dropdownIconProps);
    ...
    return React13.createElement("div", triggerProps, dropdownIcon2);
  };
  ...
  return React13.createElement(React13.Fragment, null, React13.createElement("div", rootProps, keyboardHelper, hiddenSelect, labelElement, clearIcon, dropdownIcon, React13.createElement(DropdownPanel, _extends7({
    hostName: "Dropdown",
    ref: overlayRef,
    visibleOptions,
    virtualScrollerRef
    ...
    firstFocusableElement: React13.createElement("span", firstHiddenFocusableElementProps),
    lastFocusableElement: React13.createElement("span", lastHiddenFocusableElementProps),
    sx
  }))), hasTooltip && React13.createElement(Tooltip, _extends7({
    target: elementRef,
